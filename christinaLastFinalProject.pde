/*************************************************************************************
Data Visualization - 3D Map of Spatially situated research at UCSB               
Tested in Processing 3                                    
                                                     
Author: Christina Last                       
Supervisor: Rodger Luo                           

Purpose: To show the locations of spatial research at UCSB.

Usage: 1. A key pressed will pause and restart the rotation of the earth
          2. Hovering over the department names will highlight only their geographically embedded research links 
          3. Hovering over the department names will highlight the thesis titles associated with the geographic placenames in the visualisation 
          4. Hovering away from the department list will bring original visualisation of all geographic links. 
*************************************************************************************/
...
void setup() {
  ...
  for (int i = 0; i < locationsCount; i++) {
    ...
    locationHeights[i] = map(pow(1.4, numberOfItems), 0, maxHeight, 10, 100);
